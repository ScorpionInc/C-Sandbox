...
do
	...
	#gcc -ggdb -Wall -Wextra -pedantic -Wundef -Wcast-align -Wconversion "$test" "$libPath" "$unitySrc" ../si_data/src/* ../si_core/src/* -I../si_data/include -I../si_core/include -I./include -I./tests_include -I"$unityInclude" -lm -lacl -o "$outputFinal"
	# For some reason not working(?)
	gcc -ggdb -Wall -Wextra -pedantic -Wundef -Wcast-align -Wconversion "$test" "$libPath" "$unitySrc" ../si_core/src/* -I../si_core/include -I./include -I./tests_include -I"$unityInclude" -lm -o "$outputFinal"
