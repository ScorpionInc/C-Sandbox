...
do
	...
	gcc -ggdb -Wall -Wextra -pedantic -Wundef -Wcast-align -Wconversion -rdynamic "$test" "$libPath" "$unitySrc" -I./include -I./tests_include -I"$unityInclude" -lm -lacl -o "$outputFinal"
