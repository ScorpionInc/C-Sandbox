...
void si_array_new (si_array_t* p_dynamic, const size_t element_size);
 ...
 */
void* si_array_first(const si_array_t* p_dynamic);
 ...
 * @return Returns pointer into heap memory of element size on success. Or NUll
 */
void* si_array_last(const si_array_t* p_dynamic);
