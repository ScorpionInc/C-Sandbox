...
typedef struct si_singular_blist
{
	size_t count;
	size_t capacity;
	struct si_singular_list* p_head;
	struct si_singular_list* p_tail;
...
void si_singular_blist_init_4(si_singular_blist* const p_list,
	...
	int (*p_cmp_f)(const void* const, const void* const));
void si_singular_blist_init_3(si_singular_blist* const p_list,
	const bool is_circular, const size_t initial_capacity);
void si_singular_blist_init_2(si_singular_blist* const p_list,
	const bool is_circular);
void si_singular_blist_init(si_singular_blist* const p_list);
...
si_singular_blist* si_singular_blist_new_3(const bool is_circular,
	...
	int (*p_cmp_f)(const void* const, const void* const));
si_singular_blist* si_singular_blist_new_2(const bool is_circular,
	const size_t initial_capacity);
si_singular_blist* si_singular_blist_new_1(const bool is_circular);
si_singular_blist* si_singular_blist_new();
 ...
 */
si_singular_blist* si_singular_blist_last_node(const si_singular_blist* const p_list);
...
void si_singular_blist_set_circular_2(si_singular_blist* const p_list,
	const bool is_circular);
void si_singular_blist_set_circular(si_singular_blist* const p_list);
